...
const $c0f2229dc225bedf$var$updateColorPicker = ()=>{
    const markComputedStyle = getComputedStyle(document.querySelector("mark"));
    document.querySelector('input[type="color"]').value = $c0f2229dc225bedf$var$rgbToHex(markComputedStyle.backgroundColor);
};
const $c0f2229dc225bedf$var$themes = {
    default: (0, (/*@__PURE__*/$parcel$interopDefault($6a895772f663926c$exports))),
    amber: (0, (/*@__PURE__*/$parcel$interopDefault($0d41ff21111ab0b8$exports))),
    jade: (0, (/*@__PURE__*/$parcel$interopDefault($9e2564d66d947e3f$exports))),
    purple: (0, (/*@__PURE__*/$parcel$interopDefault($3b15604ff4de90a5$exports))),
    sand: (0, (/*@__PURE__*/$parcel$interopDefault($af1fa13e1cb86ae7$exports)))
};
const $c0f2229dc225bedf$var$updateTheme = (theme)=>{
    document.querySelector("aside style").innerHTML = theme;
    requestAnimationFrame(()=>$c0f2229dc225bedf$var$updateColorPicker());
...
document.querySelector(".dropdown.theme").addEventListener("change", (e)=>{
    ...
    $c0f2229dc225bedf$var$updateTheme($c0f2229dc225bedf$var$themes[e.target.value]);
});
$c0f2229dc225bedf$var$updateTheme($c0f2229dc225bedf$var$themes.default);
const $c0f2229dc225bedf$var$colorSchemes = {
    auto: "light dark",
    light: "light",
    dark: "dark"
};
const $c0f2229dc225bedf$var$updateColorScheme = (colorScheme)=>{
...
document.querySelector(".dropdown.color-scheme").addEventListener("change", (e)=>{
    ...
    $c0f2229dc225bedf$var$updateColorScheme($c0f2229dc225bedf$var$colorSchemes[e.target.value]);
});
$c0f2229dc225bedf$var$updateColorScheme($c0f2229dc225bedf$var$colorSchemes.auto);


//# sourceMappingURL=pix.91542a99.js.map
